...
interface MagicBackgroundContextType {
    isMagicActive: boolean;
    toggleMagic: () => void;
}

const MagicBackgroundContext = createContext<MagicBackgroundContextType | undefined>(undefined);

export const useMagicBackground = () => {
    const context = useContext(MagicBackgroundContext);
    if (!context) {
        throw new Error('useMagicBackground must be used within a MagicBackgroundProvider');
    }
    return context;
};

// WebGL Shader Background Component
const ShaderBackground: React.FC<{ isActive: boolean }> = ({ isActive }) => {
...
export const MagicBackgroundProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
        <MagicBackgroundContext.Provider value={{ isMagicActive, toggleMagic }}>
            <ShaderBackground isActive={isMagicActive} />
            {children}
